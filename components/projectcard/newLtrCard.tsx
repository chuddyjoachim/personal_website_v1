    ...
    <>
      <div>
        <div className="flex flex-col sm:flex-row ">
          <div className="img-- w-full sm:w-1/2 sm:rounded-l-xl">
            <NextImage src={flexImage} className="sm:rounded-l-xl" />
          </div>
          <div className="content__ flex-1 border border-gray-200 mb-1.5 sm:border-l-0 sm:rounded-r-xl">
