    ...
    <PageWrapper>
      ...
      >
        ...
        <h1 className="text-center">
          I also engage in <strong>UX/UI/PRODUCT Design</strong>, I have a wide range of knowledge
          in Design principles and concept, and also have attained proficiency in using design tools
          such as <strong>Adobe XD</strong>, <strong>Figma</strong> e.t.c.
        </h1>
